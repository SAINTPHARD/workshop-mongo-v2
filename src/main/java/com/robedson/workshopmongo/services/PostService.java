...
public class PostService {
	...
	/**
	 * Após a implementação do postrepository, vamos criar o controlador REST que
	 * vai receber a requisição GET /posts/{id}. Na classe PostResource, e
	 * im´lementar o método findById, que vai ser chamado pelo controlador
	 */
	...
	public List<Post> fullSearch(String text, Date minDate, Date maxDate) {
		// Adiciona um dia (24h) na data máxima para pegar até o final do dia
